...
function Team() {
  return (
    <div className="container">
      ...
      <div className="row p-3 mb-5 text-center" style={{marginTop:"90px", marginLeft:"10px"}}>
        <div className="col-4 ">
          <img
          ...
          <h4
            className="mt-4"
            style={{ fontFamily: "inter", color: "#424242", fontSize:"1.125rem" }}
          >
            Nithin Kamath
          </h4>
          <h5
      ...
      <div className="row p-3 text-center" style={{marginTop:"90px", marginLeft:"10px", marginBottom:"80px"}}>
         <div className="col-4 ">
          <img
