...
function Hero() {
    return ( 
        <div className='container p-3 mb-5 mt-5'>
            <div className='row text-center' style={{display:'flex', justifyContent:'center', alignItems:'center', marginTop:"65px"}}>
                <img style={{width:"60%"}} src="media/Image/homeHero.png" alt='Hero Image' className='mb-4'/>
