  ...
  const pricingData = {
    ...
    currency: {
      ...
      rows: [
        ...
        {
          label: "GST",
          values: Array(2).fill("18% on (brokerage + SEBI charges + transaction charges)")
        },
        {
          label: "SEBI charges",
    ...
    <div className="container p-3" style={{fontFamily:"inter, serif"}}>
      ...
      <ul className="nav nav-tabs mb-4" id="pricingTabs">
        <li className="nav-item">
          <button 
            ...
            onClick={() => setActiveTab('equity')} style={{fontSize:"24px", fontStyle:"inter"}}
          >
            Equity
          </button>
        </li>
        <li className="nav-item">
          <button 
            ...
            onClick={() => setActiveTab('currency')} style={{fontSize:"24px", fontStyle:"inter"}}
          >
            Currency
          </button>
        </li>
        <li className="nav-item">
          <button 
            ...
            onClick={() => setActiveTab('commodity')} style={{fontSize:"24px", fontStyle:"inter"}}
          >
            Commodity
          </button>
        </li>
      ...
      <div>
        <table className="border table align-middle">
          <thead>
            <tr>
              <th className="text-start p-4 align-center" style={{ width: "180px" }}></th>
      ...
      <div className="text-center mt-4">
        <p className='fs-5 mt-3' style={{fontFamily:"inter, serif"}}> <a href="" style={{textDecoration:"none"}}>Calculate your costs upfront</a> using our brokerage calculator</p>
      </div>
    </div>
  );
};
