  ...
  return (
    <div className="container">
      <div
        ...
        style={{ color: "#424242", fontStyle: "inter, serif" }}
      >
        ...
        <div
          ...
          style={{
            color: "#424242",
            fontStyle: "inter, serif",
            fontSize: ".85rem",
          }}
        >
          <h2 className="mt-3 mb-3" style={{ fontSize: "1.02rem" }}>
        ...
        <div
          ...
          style={{ color: "#424242", fontStyle: "inter,serif" }}
        >
          <h3 style={{ fontSize: "1.1rem", marginBottom: "22px" }}>
            Disclaimer
          </h3>
          <p style={{ fontSize: ".79rem" }} className="mb-5">
