...
function Brokerage(){
    return(
        <div className="container">
            <div className="row mt-5 p-2" style={{color:"#424242", fontStyle:"inter, serif"}}>
                <h2 className="fs-4">Charges explained</h2>
                <div className="col-6 mt-4" style={{color:"#424242", fontStyle:"inter, serif",fontSize: ".85rem"}}>
                    <h2 className="mt-3 mb-3" style={{fontSize:"1.02rem"}}>Securities/Commodities transaction tax</h2>  
                    ...
                    <h2 className="mt-3 mb-3" style={{fontSize:"1.02rem"}}>Transaction/Turnover Charges</h2>
                    ...
                    <h2 className="mt-3 mb-3" style={{fontSize:"1.02rem"}}>Call & trade</h2>
                    <p>Additional charges of ₹50 per order for orders placed through a dealer at Zerodha including auto square off orders.</p>

                    <h2 className="mt-3 mb-3" style={{fontSize:"1.02rem"}}>Stamp charges</h2>
                    ...
                    <h2 className="mt-3 mb-3" style={{fontSize:"1.02rem"}}>NRI brokerage charges</h2>
                    <ul>
                    ...
                    <h2 className="mt-3 mb-3" style={{fontSize:"1.02rem"}}>Account with debit balance</h2>
                    ...
                    <h2 className="mt-3 mb-3" style={{fontSize:"1.02rem"}}>Charges for Investor's Protection Fund Trust (IPFT) by NSE</h2>
                    <ul>
                    ...
                    <h2 className="mt-3 mb-3" style={{fontSize:"1.02rem"}}>Margin Trading Facility (MTF)</h2>
                    <ul>
                ...
                <div className="col-6 mt-4" style={{color:"#424242", fontStyle:"inter, serif",fontSize: ".85rem"}}>
                    <h2 className="mt-3 mb-3" style={{fontSize:"1.02rem"}}>GST</h2>
                    ...
                    <h2 className="mt-3 mb-3" style={{fontSize:"1.02rem"}}>SEBI Charges</h2>
                    <p className="mb-4">Charged at ₹10 per crore + GST by Securities and Exchange Board of India for regulating the markets.</p>

                    <h2 className="mt-3 mb-3" style={{fontSize:"1.02rem"}}>DP (Depository participant) charges</h2>
                    ...
                    <h2 className="mt-3 mb-3" style={{fontSize:"1.02rem"}}>Pledging charges</h2>
                    <p className="mb-4">₹30 + GST per pledge request per ISIN.</p>

                    <h2 className="mt-3 mb-3" style={{fontSize:"1.02rem"}}>AMC (Account maintenance charges)</h2>
                    <p className="mb-4">For BSDA demat account: Zero charges if the holding value is less than ₹4,00,000. To learn more about BSDA, Click here</p>
                    <p className="mb-4">For non-BSDA demat accounts: ₹300/year + 18% GST charged quarterly (90 days). To learn more about AMC, Click here</p>

                    <h2 className="mt-3 mb-3" style={{fontSize:"1.02rem"}}>Corporate action order charges</h2>
                    <p className="mb-4">₹20 plus GST will be charged for OFS / buyback / takeover / delisting orders placed through Console.</p>

                    <h2 className="mt-3 mb-3" style={{fontSize:"1.02rem"}}>Off-market transfer charges</h2>
                    <p className="mb-4">₹25 per transaction.</p>

                    <h2 className="mt-3 mb-3" style={{fontSize:"1.02rem"}}>Physical CMR request</h2>
                    <p className="mb-4">First CMR request is free. ₹20 + ₹100 (courier charge) + 18% GST for subsequent requests.</p>

                    <h2 className="mt-3 mb-3" style={{fontSize:"1.02rem"}}>Payment gateway charges</h2>
                    <p className="mb-4">₹9 + GST (Not levied on transfers done via UPI)</p>

                    <h2 className="mt-3 mb-3" style={{fontSize:"1.02rem"}}>Delayed Payment Charges</h2>
                    <p className="mb-4">Interest is levied at 18% a year or 0.05% per day on the debit balance in your trading account. Learn more.</p>

                    <h2 className="mt-3 mb-3" style={{fontSize:"1.02rem"}}>Trading using 3-in-1 account with block functionality</h2>
                    <ul>
                        <li className="mb-3">Delivery & MTF Brokerage: 0.5% per executed order.</li>
                        <li className="mb-3">Intraday Brokerage: 0.05% per executed order.</li>
                    </ul>
                </div>
                <div className="row mt-4" style={{color:"#424242", fontStyle:"inter,serif"}}>
                    <h3 style={{fontSize:"1.1rem", marginBottom:"22px"}}>Disclaimer</h3>
                    <p style={{fontSize:".79rem"}} className="mb-5">For Delivery based trades, a minimum of ₹0.01 will be charged per contract note. Clients who opt to receive physical contract notes will be charged ₹20 per contract note plus courier charges. Brokerage will not exceed the rates specified by SEBI and the exchanges. All statutory and regulatory charges will be levied at actuals. Brokerage is also charged on expired, exercised, and assigned options contracts. Free investments are available only for our retail individual clients. Companies, Partnerships, Trusts, and HUFs need to pay 0.1% or ₹20 (whichever is less) as delivery brokerage. A brokerage of 0.25% of the contract value will be charged for contracts where physical delivery happens. For netted off positions in physically settled contracts, a brokerage of 0.1% will be charged.</p>
                </div>
            </div>
        </div>
    );
